...
/* Keep the old symbol for already-built vendor modules. */
void __iomem *ioremap_prot(phys_addr_t phys, size_t size, unsigned long prot);

static inline void __iomem *ioremap_user_prot(phys_addr_t phys, size_t size,
...
#define ioremap_prot ioremap_user_prot
